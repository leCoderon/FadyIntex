...
@section('title', 'Toutes propriétés')
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">Nos Propriétés </h1>
            ...
            <div class="row d-flex justify-content-center mb-5">
                <div class="col-lg-12 text-center mx-auto mb-5">
                    ...
                    <form action="{{ route('property.index') }}" method="get"
                        class="gap-2  row mb-5 px-3 flex-column flex-md-row" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <input type="number" class="form-control col" name="price" placeholder="Budget max"
                            value="{{ $input['price'] ?? '' }}" />
                        <input type="text" class="form-control col" name="title" placeholder="Mot clef. ex: Terrain..."
                            value="{{ $input['title'] ?? '' }}" />

                        <div class="mt-3"> <button type="submit" class="btn btn-primary btn-md">Rechercher</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
                ...
                @empty
                    <div class="alert text-white mt-4" style="background: #005555">
                        Aucune propriété trouvé
                    </div>
                @endforelse

            </div>
            <div class="row align-items-center py-5 justify-content-end">
                ...
                <div class="col-12">
                    <div class="property-slider-wrap">
                        <div class="property-slider">
                            ...
                            @endforeach --}}
                            @forelse ($propertiesAll as $property)
                                {{-- @dump($property->images->first()->name) --}}
